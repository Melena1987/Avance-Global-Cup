...
const Hero: React.FC = () => {
    const teamLogos = [
        ...
        { name: 'Cerrado Basquete', url: 'https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1762034898234_cerrado_basquete_400x400.png?alt=media&token=f0d1b3e2-1e9a-4c8a-9a6d-e2d4e7f3c1b7' },
        { name: 'OrangeAcademy', url: 'https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1762034898234_orange_academy_400x400.png?alt=media&token=c3d9b1e7-f2a8-4b7d-8f9c-a1b3d5e7f9a2' },
        { name: 'Guangdong Southern Tigers', url: 'https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1762034898234_guangdong_400x400.png?alt=media&token=b7a5c3e9-d8f6-4e1b-9a2c-f3e5d7b9a1d4' },
    ];
