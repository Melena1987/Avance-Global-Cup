...
const Hero: React.FC = () => {
    const teamLogos = [
        ...
        { name: 'Mega', url: 'https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1762452787241_Mega_400x400.png?alt=media&token=657db674-8dfc-4a37-a316-a37cd017af0a' },
    ];
