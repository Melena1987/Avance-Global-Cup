...
const Hero: React.FC = () => {
    const teamLogos = [
        ...
        { name: 'AUS Elite', url: 'https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1763100821588_aus_elite.png?alt=media&token=b515bbca-d05a-4225-9215-fc00769b9ef2' },
        { name: 'Varese Academy', url: 'https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1761946892702_varese_400x400.png?alt=media&token=467519c9-50df-4582-b6f4-0202f5aa5ba9' },
        ...
        { name: 'IMG Academy', url: 'https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1762452787242_IMG_academy_logo_400x400.png?alt=media&token=d21c3f3e-db46-4e5d-b069-151866628954' },
    ];
        ...
        <div className="scrolling-ribbon">
            <div className="scrolling-ribbon-content">
              {[...teamLogos, ...teamLogos].map((logo, index) => {
                  ...
                  return (
                      <div key={`${logo.name}-${index}`} title={logo.name} className="flex-shrink-0 w-20 mx-6 flex items-center justify-center transition-transform duration-300 ease-in-out hover:scale-105">
                          <img 
                            src={logo.url} 
                            alt={`${logo.name} logo`} 
                            className={`w-auto object-contain ${isSpecialLogo ? 'h-16' : 'h-20'} opacity-80 hover:opacity-100 transition-opacity`}
                          />
                      </div>
                  );
              })}
