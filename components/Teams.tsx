    ...
    <section id="teams" className="py-20 bg-[#151f28] overflow-hidden">
      <div ref={contentRef} className={`reveal ${isVisible ? 'visible' : ''} container mx-auto px-6 text-center`}>
        ...
        <div className="w-full max-w-6xl mx-auto rounded-lg overflow-hidden">
          <img 
              src="https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1761949515635_mapa_con_logos_avnace_global_cup.png?alt=media&token=39d09cdf-da23-4e48-8ce5-3f97eaa831ce" 
